...
wget https://raw.githubusercontent.com/nnposter/nndefaccts/master/http-default-accounts-fingerprints-nndefaccts.lua -O /usr/share/nmap/scripts/http-default-accounts.nse
